...
Page({
  data: {
      ...
      array: [
          ...
          // { id: 'file', type: 'file', value: '', title: '附件', required: true },
      ],
      allMoney: 0,
      allMoneyTitle: '总金额',
      ...
      formList: [
        ...
        { key: 'FPURCHASEDEPTID_E', type: 'text', value: '', title: '申请部门', required: true},
        ...
        { key: 'FPURPOSEID', type: 'picker', value: 'SFKYT12_SYS', title: '付款用途', required: true,
  ...
  changes(value) {
    ...
    switch(value.key) {
      case 'FDATE':
          ...
          break;
      case 'FPAYORGID':
          this.getFPAYORGID();           // 打开选中公司/部门控件
          break;
      case 'FCONTACTUNIT':
          this.getFCONTACTUNIT();
          break;
      case 'FPURCHASERID':
  ...
  renderDepartment(v) {
    ...
    this.getItemByKey(formList, 'key', 'FPURCHASEDEPTID_E').value = v.dep.name
    this.getItemByKey(formList, 'key', 'FPURCHASEDEPTID_E').id = v.dep.id
